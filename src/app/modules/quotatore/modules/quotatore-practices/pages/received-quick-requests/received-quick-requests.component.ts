...
@Component({
  selector: 'app-received-quick-requests',
  templateUrl: './received-quick-requests.component.html',
  styleUrls: ['./received-quick-requests.component.scss']
})
export class ReceivedQuickRequestsComponent implements OnInit, OnDestroy {
  ...
  /************************************************************************************************************/
    ...
    constructor(
      ...
      this.actions = actionGenerator.generateActions(17);
    }

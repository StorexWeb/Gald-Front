...
@Component({
    selector: 'app-pending-estimates',
    templateUrl: './pending-estimates.component.html',
    styleUrls: ['./pending-estimates.component.scss']
})
export class PendingEstimatesComponent implements OnInit, OnDestroy {

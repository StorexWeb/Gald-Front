...
@Component({
  selector: 'app-rent-leasys',
  templateUrl: './rent-leasys.component.html',
  styleUrls: ['./rent-leasys.component.scss']
})
export class RentLeasysComponent implements OnInit {
  ...
  constructor(
    ...
    this.practices = this.route.snapshot.data.data.practices;
     ...
     this.filterPractice('Leasys', this.practices);

...
@Component({
  selector: 'app-rent-accepted',
  templateUrl: './rent-accepted.component.html',
  styleUrls: ['./rent-accepted.component.scss']
})
export class RentAcceptedComponent implements OnInit {
  actions = [];

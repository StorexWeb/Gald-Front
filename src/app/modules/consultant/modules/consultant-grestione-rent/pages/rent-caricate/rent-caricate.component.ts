...
@Component({
  selector: 'app-rent-caricate',
  templateUrl: './rent-caricate.component.html',
  styleUrls: ['./rent-caricate.component.scss']
})
export class RentCaricateComponent implements OnInit {

...
@Component({
  selector: 'app-rent-rifiutate',
  templateUrl: './rent-rifiutate.component.html',
  styleUrls: ['./rent-rifiutate.component.scss']
})
export class RentRifiutateComponent implements OnInit {
  ...
  constructor(
    ...
    this.actions = actionGenerator.generateActions(24);

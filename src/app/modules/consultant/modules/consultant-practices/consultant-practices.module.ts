...
import {ConsultantPracticesRoutingModule} from './consultant-practices-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    ConsultantPracticesRoutingModule,
    SharedModule,
    FormsModule,
    ReactiveFormsModule,
    HttpClientModule,
...
export class ConsultantPracticesModule { }

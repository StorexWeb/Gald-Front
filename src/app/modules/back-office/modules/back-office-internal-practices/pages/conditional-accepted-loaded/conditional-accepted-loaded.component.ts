...
@Component({
    selector: 'app-conditional-accepted-loaded',
    templateUrl: './conditional-accepted-loaded.component.html',
    styleUrls: ['./conditional-accepted-loaded.component.scss']
})
export class ConditionalAcceptedLoadedComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.actions = this.actionGenerator.generateActions(12);

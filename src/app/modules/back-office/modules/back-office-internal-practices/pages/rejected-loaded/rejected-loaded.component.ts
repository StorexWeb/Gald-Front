...
@Component({
    selector: 'app-rejected-loaded',
    templateUrl: './rejected-loaded.component.html',
    styleUrls: ['./rejected-loaded.component.scss']
})

export class RejectedLoadedComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.actions = this.actionGenerator.generateActions(13);

...
@Component({
    selector: 'app-accepted-loaded',
    templateUrl: './accepted-loaded.component.html',
    styleUrls: ['./accepted-loaded.component.scss']
})
export class AcceptedLoadedComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.actions = this.actionGenerator.generateActions(11);

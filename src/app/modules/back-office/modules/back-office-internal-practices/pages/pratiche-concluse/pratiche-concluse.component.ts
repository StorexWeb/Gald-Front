...
@Component({
  selector: 'app-pratiche-concluse',
  templateUrl: './pratiche-concluse.component.html',
  styleUrls: ['./pratiche-concluse.component.scss']
})
export class PraticheConcluseComponent implements OnInit {
  actions = [];
  ...
  constructor(
    ...
    this.actions = actionGenerator.generateActions(26);

...
@Component({
    selector: 'app-ready-waiting-activation',
    templateUrl: './ready-waiting-activation.component.html',
    styleUrls: ['./ready-waiting-activation.component.scss']
})
export class ReadyWaitingActivationComponent implements OnInit, OnDestroy {

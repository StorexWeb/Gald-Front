...
@Component({
    selector: 'app-client-ready-rejected',
    templateUrl: './client-ready-rejected.component.html',
    styleUrls: ['./client-ready-rejected.component.scss']
})
export class ClientReadyRejectedComponent implements OnInit, OnDestroy {

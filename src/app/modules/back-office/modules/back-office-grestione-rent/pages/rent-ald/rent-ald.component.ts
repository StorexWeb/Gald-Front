...
@Component({
  selector: 'app-rent-ald',
  templateUrl: './rent-ald.component.html',
  styleUrls: ['./rent-ald.component.scss']
})
export class RentAldComponent implements OnInit {
  ...
  constructor(
    ...
    this.actions = actionGenerator.generateActions(21);

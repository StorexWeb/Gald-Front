...
@Component({
  selector: 'app-rent-arval',
  templateUrl: './rent-arval.component.html',
  styleUrls: ['./rent-arval.component.scss']
})
export class RentArvalComponent implements OnInit {
  ...
  load(): void {
    this.practiceService.listPractices(
        'SVILUPPA_RENT_REJECTED_BACK_OFFICE' ,
